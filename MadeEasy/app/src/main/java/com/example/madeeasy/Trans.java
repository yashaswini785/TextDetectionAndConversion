...
import static com.example.madeeasy.GlobalVars.BASE_REQ_URL;
import static com.example.madeeasy.GlobalVars.DEFAULT_LANG_POS;
import static com.example.madeeasy.GlobalVars.LANGUAGE_CODES;

public class Trans extends AppCompatActivity implements TextToSpeech.OnInitListener{

    public static final String LOG_TAG = Trans.class.getName();
    ...
    private String mLanguageCodeTo = "kn";                  //    Language Code (To)
    private ImageView mImageSpeak;                          //    Speak button to read out translated text (Text to Speech)
    private TextView mTextInput;                            //    Input text ( in From language )
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        process_tts = new Dialog(Trans.this);
        ...
        if (!isOnline()) {
            ...
            mButtonTranslate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    StringBuilder inp =Trans.in;
                    mTextInput.setText(inp.toString());
                    String input = Trans.in.toString();
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                     ...
                     */
                    final Dialog match_text_dialog = new Dialog(Trans.this);
    ...
    private class GetLanguages extends AsyncTask<Void,Void,ArrayList<String>>{
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (activityRunning) {
                ArrayAdapter<String> adapter = new ArrayAdapter<>(Trans.this, android.R.layout.simple_spinner_item, result);
                ...
                mSpinnerLanguageTo.setSelection(29);
            }
        }
    }
}